...
Companion code and data for the paper *The Verdict Never Rendered: Construct Validity, Non-Stationarity, and Selection in Two Centuries of Old-Versus-New Violin Trials* (F. Levi Mazloum, submitted to *Musicae Scientiae*, 2026). Interactive results: https://www.ruederome.com/trend.php
